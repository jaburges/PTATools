    ...
    <div class="azure-plugin-dashboard">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <span class="description">
                                ...
                                "test"-keyword accounts, name+long-digit-run usernames (e.g. <code>firstname.lastname6386</code>),
        ...
        <div class="azure-plugin-settings">
            <form method="post" action="">
                ...
                <?php
                // Calendar Sync Connection lives on Calendar > Config tab
                // (admin.php?page=azure-plugin-calendar&tab=config) since
                // v3.115. Auth/mailbox config used to be inlined here but
                // belonged with the rest of the calendar admin.
                ?>
