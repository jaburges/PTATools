...
$t->equals('Wilder PTSA volunteering reminder', Azure_Volunteer_Signup::reminder_subject(), 'reminder subject is fixed');
...
$t->check(Azure_Volunteer_Signup::reminder_is_due($start, $start_ts - (int) (2.5 * 3600)), 'a shift two and a half hours away is due');
$t->check(!Azure_Volunteer_Signup::reminder_is_due($start, $start_ts - (4 * 3600)), 'a shift four hours away waits for a later sweep');
